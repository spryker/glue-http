    ...
    public function validate(GlueRequestTransfer $glueRequestTransfer): GlueRequestValidationTransfer
    {
        ...
        if (
            ...
            return (new GlueRequestValidationTransfer())
                ->setIsValid(false)
                ->setValidationError('One or more of the required headers (access-control-request-method, access-control-request-headers, origin) for the options method are missing.')
                ->setStatusCode(Response::HTTP_NOT_IMPLEMENTED);
        }
