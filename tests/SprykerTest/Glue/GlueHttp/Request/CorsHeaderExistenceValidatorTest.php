...
class CorsHeaderExistenceValidatorTest extends Unit
{
    ...
    public function testCorsHeaderNonExist(): void
    {
        ...
        $this->assertSame('One or more of the required headers (access-control-request-method, access-control-request-headers, origin) for the options method are missing.', $glueRequestValidationTransfer->getValidationError());
    }
